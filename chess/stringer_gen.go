// Code generated by "stringer -type=Piece,Color,Square,State,MovementType -output=stringer_gen.go"; DO NOT EDIT.
...
func (i Color) String() string {
	if i >= Color(len(_Player_index)-1) {
...
const _State_name = "IdlePlayingCheckCheckMateDrawPromo"

var _State_index = [...]uint8{0, 4, 11, 16, 25, 29, 34}
